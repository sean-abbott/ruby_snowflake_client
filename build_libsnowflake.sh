...
source $LIB_SNOWFLAKE_DIR/deps/zlib-1.2.11/configure --static  # may add CFLAGS="-fPIC" but this looks like it does it
source $LIB_SNOWFLAKE_DIR/deps/zlib-1.2.11/make
